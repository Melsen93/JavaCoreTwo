...
public class Main {
    ...
    private void methodOne(){
        System.out.println("Старт выполнения метода 1");
        ...
        System.out.println(String.format("Завершение выполнения метода 1. Время выполнения %s", String.valueOf(end - start)));
    }

    private void methodTwo(){
        System.out.println("Старт выполнения метода 2");
        float[] arr = new float[size];
